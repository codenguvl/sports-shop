            ...
            <div class="cart-content row">
                <div class="cart-content-left">
                    <table>
                        ...
                        // Kiểm tra nếu $show_cart là mảng
                        if (is_array($show_cart)) {
                ...
                <div class="cart-content-right">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                echo $resultD;
                                Session::set('TT', $resultD); ?><sup>đ</sup>
                                </p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <p style="font-weight: bold; color: black;">
                                    <?php $resultC = number_format($TT);
                                    echo $resultC ?><sup>đ</sup>
                                </p>
                            </td>
                        </tr>
                    </table>
                    ...
                    <div class="cart-content-right-dangnhap">
                        <p>TÀI KHOẢN HONGPHUCSPORT</p> <br>
