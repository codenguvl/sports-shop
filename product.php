...
<section class="product">
    <div class="container">
        ...
        <div class="product-content row">
            ...
            // Kiểm tra nếu $get_sanpham là một mảng và có ít nhất một phần tử
            if (is_array($get_sanpham) && count($get_sanpham) > 0) {
                foreach ($get_sanpham as $result) {
                    ?>
            <div class="product-content-left row">
                ...
                <div class="product-content-left-small-img">
                    <?php
                            ...
                            // Kiểm tra nếu $get_anh là một mảng và có ít nhất một phần tử
                            if (is_array($get_anh) && count($get_anh) > 0) {
                                foreach ($get_anh as $resultA) {
                                    ?>
                ...
                <div class="product-content-right-product-size">
                    ...
                    <div class="size">
                        <?php
                                ...
                                // Kiểm tra nếu $get_size là một mảng và có ít nhất một phần tử
                                if (is_array($get_size) && count($get_size) > 0) {
                                    foreach ($get_size as $resultV) {
                                        ?>
                        <div class="size-item">
