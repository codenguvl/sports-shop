...
<div class="admin-content-right">
    <div class="product-add-content">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <input value="<?php echo $resul['so_luong'] ?>" required type="number" name="soluong"> <br>
            ...
            <textarea class="ckeditor" required name="sanpham_chitiet" cols="60"
                rows="5"><?php echo $resul['sanpham_chitiet'] ?></textarea><br>
            <label for="">Bảo quản<span style="color: red;">*</span></label> <br>
            <textarea class="ckeditor" required name="sanpham_baoquan" cols="60"
                rows="5"><?php echo $resul['sanpham_baoquan'] ?></textarea><br>
