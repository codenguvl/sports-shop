...
<div class="admin-content-right">
    <div class="table-content">
        <table>
            ...
            <?php
                    if($show_answer){$i=0; while($result= $show_answer->fetch(PDO::FETCH_ASSOC)){
                        $i++
            ...
            <tr>
                ...
                <td><a href="answerdelete.php?question_answer_id=<?php echo $result['question_answer_id'] ?>">Xóa</a>
                </td>
            </tr>
            <?php
                     }}
