            ...
            <div class="delivery-content row">
                <div class="delivery-content-left">
                    <form action="" method="post">
                        ...
                        <input type="hidden" style="float: left;margin-right:12px" checked="checked" name="loaikhach"
                            type="radio" value="khachle">
                        <!-- <p><span style="font-weight: bold;">Khách lẻ</span> (Nếu bạn không muốn lưu lại thông tin)</p> -->
                        <input type="hidden" style="float: left;margin-right:12px" class="register-input" name="loaikhach"
                            value="dangky" type="radio">
                        ...
                        <div class="delivery-content-left-input-top row">
                            ...
                            <div class="delivery-content-left-input-top-item">
                                ...
                                <select name="customer_tinh" id="tinh_tp"
                                    ...
                                    if ($show_diachi) {
                                        while ($result = $show_diachi->fetch(PDO::FETCH_ASSOC)) {
                                            ?>
                        ...
                        if ($show_cartB) {
                            while ($result = $show_cartB->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p><?php echo number_format($result['sanpham_gia'] * $result['quantitys']); ?><sup>đ</sup>
                                        </p>
                                    </td>
                                </tr>
                                <?php
