...
$redirectUrl = "http://localhost:2222/HongPhuc-Sport/HongPhuc-Sport/xac_nhan_thanh_toan.php";
$ipnUrl = "http://localhost:2222/HongPhuc-Sport/HongPhuc-Sport/xac_nhan_thanh_toan.php";
$extraData = "";
